export const CONFIG = {
  ...
  language: 'PhoNZE', // This changes the display name for your language
  ...
  wordListSource: 'NZE dictionary from Catherine Watson', // Describe the source material for your words here
